/*
Retrieved by Dylan Gentile for DeweyCoin from the eXtended Keccak Code Package (XKCP) from 
...
/**
  ...
  */
void FIPS202_SHA3_256(const unsigned char *input, unsigned long long int inputByteLen, unsigned char *output)
{
